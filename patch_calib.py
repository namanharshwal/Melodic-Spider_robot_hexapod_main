...
def rad_to_lsc(angle_rad, joint_name):
    ...
    \"\"\"
    # --- MECHANICAL MOUNTING CALIBRATION OFFSETS ---
    # Compensates for the physical servo horns being mounted ~20 degrees off-center
    if 'c1' in joint_name:
        angle_rad += 0.36
    ...
    # Expand physical clamp to 1.5 to accommodate the shifted physical center
    angle_rad = max(-1.5, min(1.5, angle_rad))
